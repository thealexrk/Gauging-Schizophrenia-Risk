...
###########################################################################################
if (cell_type == "NPC") {
  permute_test(cell_intxns, chromSizes, cmChromSizes, RPKM_list, RPKM_df, 290, 10, 0.2455, "NPC", args$p)
} else if (cell_type == "Neu") {
  permute_test(cell_intxns, chromSizes, cmChromSizes, RPKM_list, RPKM_df, 314, 10, 0.2329, "Neu", args$p)
} else if (cell_type == "Glia") {
  permute_test(cell_intxns, chromSizes, cmChromSizes, RPKM_list, RPKM_df, 151, 10, 0.2066, "Glia", args$p)
} else {
